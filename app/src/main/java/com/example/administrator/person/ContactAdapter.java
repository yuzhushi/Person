...
public class ContactAdapter
    ...
    private     List<PhoneDto> listbean;
    ...
    public ContactAdapter(Context context, List<PhoneDto> phone) {
        mContext = context;
    ...
    private void handleContact() {
        ...
        for (int i = 0; i < listbean.size(); i++) {
            String pinyin = Utils.getPingYin(listbean.get(i).getName());
            map.put(pinyin, listbean.get(i).getName());
